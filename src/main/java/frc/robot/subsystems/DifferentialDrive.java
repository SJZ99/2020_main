/**
 * Modify the parameter to match TalonFX(Falcon)
 * The WPI's DifferentDrive invert the rightside motor, now is not
 */
...
public class DifferentialDrive extends RobotDriveBase implements Sendable, AutoCloseable {
  ...
  /**
   * this will invert the right side output
   *  1.0  -> false
   * -1.0  -> true
   */
   ...
   *
   * @param leftMotor  leftmotor master
   * @param rightMotor rightmotor master
   */
  public DifferentialDrive(WPI_TalonFX leftMotor, WPI_TalonFX rightMotor) {
  ...
  private void verify(WPI_TalonFX leftMotor, WPI_TalonFX rightMotor) {
